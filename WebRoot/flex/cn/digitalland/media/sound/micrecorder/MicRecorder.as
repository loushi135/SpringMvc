package cn.digitalland.media.sound.micrecorder
{
	...
	public final class MicRecorder extends EventDispatcher
	{
		 ...
		 * 
		 */		
		public function MicRecorder(encoder:IEncoder, microphone:Microphone=null, gain:uint=50, rate:uint=44, silenceLevel:uint=0, timeOut:uint=4000)
		{
			_encoder = encoder;
